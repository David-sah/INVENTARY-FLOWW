            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="compras.php">
                        <i class="mdi mdi-puzzle-outline"></i> <span ><?=$lang['t-compras']?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="proveedores.php">
                        <i class="mdi mdi-puzzle-outline"></i> <span ><?=$lang['t-proveedor']?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="sucursales.php">
                        <i class="mdi mdi-puzzle-outline"></i> <span ><?=$lang['t-sucursal']?></span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="usuarios.php">
                        <i class="mdi mdi-puzzle-outline"></i> <span ><?=$lang['t-empleado']?></span>
                    </a>
                </li>     
                <li class="nav-item">
                    <a class="nav-link menu-link" href="productos.php">
                        <i class="mdi mdi-puzzle-outline"></i> <span ><?=$lang['t-producto']?></span>
                    </a>
                </li>                
