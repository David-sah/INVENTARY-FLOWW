                ...
                <div class="modal-content">
                    ...
                    <form>
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="categorianame-field" class="form-label">Nombre</label>
                                <input type="text" id="categorianame-field" class="form-control" placeholder="Enter Name" required />
                            </div>

                            <div class="mb-3">
                                <label for="Description-field" class="form-label"><?= $lang["t-Description"] ?></label>
                                <input type="Description" id="Description-field" class="form-control" placeholder="Enter Description" required />
                            </div>

                            <div class="mb-3">
                                <label for="Image-field" class="form-label"><?= $lang["t-Image"] ?></label>
                                <input type="text" id="Image-field" class="form-control" placeholder="Enter Image no." required />
                            </div>
                        ...
                        <div class="modal-footer">
                            <div class="hstack gap-2 justify-content-end">
                                ...
                                <button type="submit" class="btn btn-success" id="add-btn">Add categoria</button>
