                        ...
                        <div class="modal-content">
                            ...
                            <form>
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="Factura-field" class="form-label">Factura</label>
                                        <input type="Factura" id="Factura-field" class="form-control" placeholder="Enter Factura" required />
                                    </div>

                                    <div class="mb-3">
                                        <label for="Sub-field" class="form-label">Sub</label>
                                        <input type="text" id="Sub-field" class="form-control" placeholder="Enter Sub no." required />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-control" data-trigger name="IVA-field" id="IVA-field">
