                            ...
                            <div class="card-body">
                                <div id="proveedorList">
                                    ...
                                    <div class="table-responsive table-card mt-3 mb-1">
                                        <table class="table align-middle table-nowrap" id="proveedorTable">
                    ...
                    <div class="modal-content">
                        ...
                        <form>
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="proveedorname-field" class="form-label">proveedor Name</label>
                                    <input type="text" id="proveedorname-field" class="form-control" placeholder="Enter Name" required />
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="Url-field" class="form-label">Joining Url</label>
                                    <input type="text" id="Url-field" class="form-control" placeholder="Select Url" required />
                                </div>
                            ...
                            <div class="modal-footer">
                                <div class="hstack gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-success" id="add-btn">Add proveedor</button>
                                    <button type="button" class="btn btn-success" id="edit-btn">UpUrl</button>
                                </div>
                            </div>
                        </form>
                    </div>
